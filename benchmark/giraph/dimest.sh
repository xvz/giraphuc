...
hadoop jar "$GIRAPH_DIR"/giraph-examples/target/giraph-examples-1.1.0-SNAPSHOT-for-hadoop-1.0.4-jar-with-dependencies.jar org.apache.giraph.GiraphRunner \
    ...
    org.apache.giraph.examples.DiameterEstimationComputation \
    -ca DiameterEstimationComputation.maxSS=30 \
    -vif org.apache.giraph.examples.io.formats.DiameterEstimationInputFormat \
    -vip /user/${USER}/input/${inputgraph} \
    -vof org.apache.giraph.examples.DiameterEstimationComputation\$DiameterEstimationVertexOutputFormat \
    -op "$outputdir" \
