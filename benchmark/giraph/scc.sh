...
## log names
logname=scc_${inputgraph}_${machines}_${execmode}_"$(date +%Y%m%d-%H%M%S)"
...
hadoop jar "$GIRAPH_DIR"/giraph-examples/target/giraph-examples-1.1.0-for-hadoop-1.0.4-jar-with-dependencies.jar org.apache.giraph.GiraphRunner \
    ...
    org.apache.giraph.examples.scc.${class}Computation \
    -mc org.apache.giraph.examples.scc.SccPhaseMasterCompute \
    -vif org.apache.giraph.examples.scc.SccLongLongNullTextInputFormat \
