 ...
 */
package org.apache.giraph.examples.okapi.common;
...
public class Parameters {
  /** Debug */
  public static final BooleanConfOption DEBUG =
      new BooleanConfOption("debug", false,
      "Enable debugging information printing");

  /** Random seed */
  public static final LongConfOption RANDOM_SEED =
      new LongConfOption("random.seed", -1,
          "Random number generator seed");

  /** Graph directed */
  public static final BooleanConfOption GRAPH_DIRECTED =
