...
public class Jaccard {
   ...
   */
  public static class SendFriendsBloomFilter extends BasicComputation<
    LongWritable, NullWritable, DoubleWritable, LongIdBloomFilter> {
   ...
   */
  public static class JaccardApproximation extends BasicComputation<
    LongWritable, NullWritable, DoubleWritable, LongIdBloomFilter> {
    ...
    public void compute(
      ...
      for (LongIdBloomFilter msg : messages) {
        ...
        // case in a directed graph, this call has no effect.
        vertex.setEdgeValue(src, new DoubleWritable(
            (double) Math.min(commonFriends, totalFriends) /
            (double) totalFriends));
      }
      if (!conversionEnabled) {
        vertex.voteToHalt();
