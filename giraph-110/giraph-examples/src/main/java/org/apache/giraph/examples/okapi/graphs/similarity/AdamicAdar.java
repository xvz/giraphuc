 ...
 */
package org.apache.giraph.examples.okapi.graphs.similarity;
 ...
 * </pre>
 *
 * Use -ca distance.conversion.enabled=true to get the
 * Adamic-Adar distance instead.
 *
...
public class AdamicAdar {
  ...
  public static final String BLOOM_FILTER_BITS =
    "adamicadar.bloom.filter.bits";
  ...
  public static final String BLOOM_FILTER_FUNCTIONS =
    "adamicadar.bloom.filter.functions";
  ...
  public static final String BLOOM_FILTER_HASH_TYPE =
    "adamicadar.bloom.filter.hash.type";
   ...
   *
   */
  public static class ComputeLogOfInverseDegree extends BasicComputation<
    LongWritable, DoubleWritable, DoubleWritable,
    LongIdDoubleValueFriendsList> {
   ...
   *
   */
  public static class SendFriendsListAndValue extends BasicComputation<
    LongWritable, DoubleWritable, DoubleWritable,
    LongIdDoubleValueFriendsList> {
    ...
    public void compute(
      ...
      if (!(friends.isEmpty())) {
        LongIdDoubleValueFriendsList msg =
          new LongIdDoubleValueFriendsList(vertex.getValue(), friends);
   ...
   * similarity. The message contains the source vertex value and a list of
   * vertex ids representing the neighbors of the source.
   */
  public static class LongIdDoubleValueFriendsList implements Writable {
     ...
     *
     * @param value value
     * @param neighborList neighborList
     */
   ...
   * vertex AdamicAdar similarity between u and v is the sum over the common
   * neighbors of u and v, of the log of the inverse degree of each of them
   *
   * This computes similarity only between vertices that are connected with
   * edges, not any pair of vertices in the graph.
   */
  public static class AdamicAdarComputation extends BasicComputation<
    LongWritable, DoubleWritable, DoubleWritable,
    LongIdDoubleValueFriendsList> {
    ...
    public void preSuperstep() {
      conversionEnabled = getConf().getBoolean(DISTANCE_CONVERSION,
                                               DISTANCE_CONVERSION_DEFAULT);
    }
        ...
        for (LongWritable id : msg.getNeighborsList()) {
          if (id != vertex.getId()) {
            if (vertex.getEdgeValue(id) != null) {
              ...
              vertex.setEdgeValue(id, new DoubleWritable(
                  currentEdgeValue.get() + partialValue.get()));
            }
          }
        }
      }
   ...
   *
   */
  public static class SendFriendsListAndValueBloomFilter
    extends BasicComputation<LongWritable, DoubleWritable,
            DoubleWritable, LongIdAndValueBloomFilter> {
   ...
   *
   */
  public static class AdamicAdarApproximation extends BasicComputation<
    LongWritable, DoubleWritable, DoubleWritable, LongIdAndValueBloomFilter> {
      ...
      for (LongIdAndValueBloomFilter msg : messages) {
        ...
        for (Edge<LongWritable, DoubleWritable> e : vertex.getEdges()) {
          ...
          if (filter.membershipTest(k)) { // common neighbor
            DoubleWritable currentEdgeValue =
              vertex.getEdgeValue(e.getTargetVertexId());
            // add up the partial value to the current sum
            vertex.setEdgeValue(e.getTargetVertexId(),
              new DoubleWritable(currentEdgeValue.get() + partialValue.get()));
          }
        }
      }
      if (!conversionEnabled) {
   ...
   * Does something
   */
  public static class ScaleToDistanceBloom extends BasicComputation<
    LongWritable, DoubleWritable, DoubleWritable, LongIdAndValueBloomFilter> {
  ...
  public static class MasterCompute extends DefaultMasterCompute {
    ...
    /** */
    private boolean approximationEnabled;
    /** */
    private boolean conversionEnabled;
