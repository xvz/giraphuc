...
package org.apache.giraph.examples.okapi.io.formats;
...
import org.apache.giraph.examples.okapi.graphs.SemiClustering.SemiClusterTreeSetWritable;
 ...
 * {@link org.apache.giraph.examples.okapi.graphs.SemiClusteringComputation}.
 *
 ...
 */
public class SemiClusteringInputFormat extends TextVertexInputFormat<
  LongWritable, SemiClusterTreeSetWritable, DoubleWritable> {
  ...
  /**
   * Vertex reader associated with {@link SemiClusteringInputFormat}.
   */
  public class SemiClusteringVertexReader extends
    ...
    @Override
    protected SemiClusterTreeSetWritable getValue(String[] tokens)
      throws IOException {
      // ignore tokens and return dummy vertex value
